...
public class FishingRodPerk extends PlayerRespawnPerk {

    public FishingRodPerk(Pit p, PlayerData playerData) {
        super(p, playerData);
    }

    @Override
    public void handlePerk(PlayerRespawnEvent e) {
        e.getPlayer().getInventory().addItem(new ItemStack(Material.FISHING_ROD));
    }
}
